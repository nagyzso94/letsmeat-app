...
class ReviewViewModel(
    ...
    private val _restaurantReviews: MutableLiveData<Resource<Response<List<Review>>>> =
        MutableLiveData()
    ...
    private val _reviewCreateResponse: MutableLiveData<Resource<ReviewCreateResponse>> =
        MutableLiveData()
    ...
    fun createReview(
        ...
        _reviewCreateResponse.value = repository.createReview(
            user_id,
            restaurant_id,
            savouriness,
            prices,
